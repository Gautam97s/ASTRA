...
import { Activity, Bell, Home, Shield, Menu, X, Cpu, Camera } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
const navigation = [
  ...
  { name: "Camera Feed", href: "/camera-feed", icon: Camera },
]
...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const hasCriticalAlert = alerts.some((alert) => alert.type === "Critical")
